...
shape_0 <- c(15, 5, 1) # setting shape (i.e. means for the 3 states)
...
# paste out
out.path <- "./Data_outputs/Testing_initial_vals_SG.csv"
write.csv(out.all, out.path, row.names=T)
...
# plotting histogram of step lenghts based on "best" models
...
# paste out
out.path <- "./Data_outputs/Testing_initial_vals_Cro.csv"
write.csv(out.all, out.path, row.names=T)
